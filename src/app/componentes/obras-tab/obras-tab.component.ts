...
export class ObrasTabComponent implements OnInit,OnDestroy {
  ...
  constructor(
    ...
    console.log('constructor obras-tab componente')
   }

  ngOnInit() {
    console.log('init obras-tab componente');
    this.getDataObras();
  }

  ngOnDestroy(): void {
    console.log('destroy obras-tab componente')
